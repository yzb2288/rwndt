...
<context>
    ...
    <message>
        <location filename="../../libs/rwr_window_style.py" line="142"/>
        <location filename="../../libs/rwr_window_style.py" line="190"/>
        <source>Game HWND: {0} Current Style: {1} Current ExStyle: {2}</source>
        <translation>游戏窗口HWND: {0} 当前样式: {1} 拓展样式: {2}</translation>
    </message>
    <message>
        <location filename="../../libs/rwr_window_style.py" line="149"/>
        <source>Set HWND {0} borderless window</source>
        <translation>设置游戏窗口{0}为无边框窗口</translation>
    </message>
    <message>
        <location filename="../../libs/rwr_window_style.py" line="162"/>
        <source>Set HWND {0} maximize on {1} ({2}x{3})</source>
        <translation>设置游戏窗口{0}在屏幕{1} ({2}x{3})中最大化</translation>
    </message>
    <message>
        <location filename="../../libs/rwr_window_style.py" line="197"/>
        <source>Set HWND {0} better window</source>
        <translation>设置游戏窗口{0}为更好的窗口样式</translation>
    </message>
    <message>
        <location filename="../../libs/rwr_window_style.py" line="208"/>
        <source>Set HWND {0} dark mode</source>
